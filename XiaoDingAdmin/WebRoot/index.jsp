...
<html>
	...
	<body>
		...
		<div id="wrapper">
			 <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
			  <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.jpg">小丁美食管理后台</a>
              </div>
              <!-- /.navbar-header -->
                	   ...
                	   <ul class="nav" id="side-menu">
                            ...
                            <a href="#"><i class="fa fa-lemon-o fa-fw"></i> 美食管理<span class="fa arrow"></span></a>
                             <ul class="nav nav-second-level">
                                <li>
                                    <a href="index.jsp" class="active">文章管理</a>
                                </li>
                                <li>
                            ...
                            <a href="brand.jsp"><i class="fa fa-apple fa-fw"></i> 品牌管理</a>
                	   	    ...
                	   	    <li>
                            <a href="admin.jsp"><i class="fa fa-book fa-fw"></i> 用户管理</a>
                        </li>
                	   </ul>
                	</div>
                	<!-- /.sidebar-collapse -->
			 ...
			 <div id="page-wrapper">
			   <div class="row">
			 	  ...
			 	  <div class="col-lg-6 col-md-6 col-sm-6 hidden-xs" style="text-align: right;">
			 	  	<a class="btn btn-success" href="gotoArticle.action" target="_blank">新增文章</a>
			 	  </div>
			 	  <div id="dataDiv">
			 	  </div>
	    ...
	    var getFirstPageOfMemo = function(){
			
			$.ajax({
			      url: "listMemoes.action",
			      datatype: 'json',
			      type: "GET",
			      data: { "pageNo": 1 },
			      dataType: "json",
			      success: function (data) {
			          ...
			          if (data != null) 
			          {
			               ...
			               var tableShow = "";
				           $.each(data.memoLists, function(i, item){
				        	 // alert(item.name + " ," + item.picPath);
				        	 tableShow += "<div class='col-sm-6 col-md-4 table-bordered table-responsive' style='margin-top:20px;'>";
				        	 tableShow += "<p class='text-muted'>" + item.date + "</p><hr/>";
				        	 tableShow += "<p class='text-capitalize'>" + item.title + "</p>";
				        	 tableShow += "<p align='center'><img src=\"" + item.picPath + "\" /></p>";
				        	 tableShow += "<p class='text-description'>" + item.summary + "</p>";
				             tableShow += "<div style='text-align: center;'>";
				             tableShow += "<a class='btn btn-default' onclick='updateBrand(\"" + item.foodId + "\",\"" + item.picId + "\")'><i class='glyphicon glyphicon-pencil'></i></a>";
				             tableShow += "<a class='btn btn-default' onclick='deleteBrand(\"" + item.foodId + "\",\"" + item.picId + "\")'><i class='glyphicon glyphicon-trash'></i></a>";
				             tableShow +="</div></div>";
				           });//end each
